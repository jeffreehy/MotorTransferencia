...
/* 46 */         ds = (DataSource)ctx.lookup("java:/MSSQLDSMotor");   // este es para JBoss pruebas y produccion
//        ds = (DataSource)ctx.lookup("jdbc/MSSQLDSMotor");            // este es para hacer pruebas con Glassfich en desarrollo
...
/* Location:              C:\jeta\Jeta Banco Atlantida\war file for ws movimientos TC\new war coneccion pool\war anterior favor no borrar\wsMovimientos.war!\WEB-INF\classes\tools\DBConnectMotor.class
