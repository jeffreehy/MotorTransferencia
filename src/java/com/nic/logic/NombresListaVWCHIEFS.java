...
import static com.nic.logic.NombresListaNic.computeLevenshteinSimilarity;
 ...
 * @author oargueta
 */
public class NombresListaVWCHIEFS {

    double similarity = 0;
    int swx = 0;
    RespuestaNombresListasNegras deta = new RespuestaNombresListasNegras();

//    public RespuestaNombresListasNegras BuscarNombreListaVWCHIEFS(String input, String ParametroValorDato) {
    public RespuestaNombresListasNegras BuscarNombreListaVWCHIEFS(long sequence, String nombre, String ParametroValorDato, String unoOvarios, Connection con, Connection connection,String horaInicio, LocalDateTime now, String actor, String ParametroValorDatoPorcentaje) {
...
//            connection = DatabaseConnection.getConnection();
            ...
            String sqlQuery = "SELECT VWCHFNAM FROM dbo.VWCHIEFS";
