 ...
 * @author oargueta
 */
public class NombresListaVWOFAC_ALL {

    double similarity = 0;
    int swx = 0;
    RespuestaNombresListasNegras deta = new RespuestaNombresListasNegras();

    public RespuestaNombresListasNegras BuscarNombreListaVWOFAC_ALL(long sequence, String nombre, String ParametroValorDato, String unoOvarios, Connection con, Connection connection,String horaInicio, LocalDateTime now, String actor, String ParametroValorDatoPorcentaje) {
...
//            connection = DatabaseConnection.getConnection();
            ...
            String sqlQuery = "SELECT VWSDN_NAME FROM dbo.VWOFAC_ALL";
...
//                System.out.println("**************** Entro uno VWOFAC_ALL :  "+ParametroValorDato);
